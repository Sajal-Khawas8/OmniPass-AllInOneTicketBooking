                ...
                <ul>
...

                    {
                        isAuthenticated ?
                            ...
                            :
                            <li> <Button className='active' onClick={() => loginWithRedirect({ redirectUri: [
                                'https://omnipass.vercel.app',
                                'https://omnipass.vercel.app/bookTrainTickets',
                                'https://omnipass.vercel.app/bookFlightTickets',
                                'https://omnipass.vercel.app/bookHotelRooms',
                                'https://omnipass.vercel.app/bookMetroTickets',
                                'https://omnipass.vercel.app/bookBusTickets',
                                'https://omnipass.vercel.app/bookMovieTickets',
                                'https://omnipass.vercel.app/about',
                                'https://omnipass.vercel.app/checkTrainLiveStatus',
                                'https://omnipass.vercel.app/checkPnrStatus',
                                'http://localhost:5173',
                                'http://localhost:5173/bookTrainTickets',
                                'http://localhost:5173/bookFlightTickets',
                                'http://localhost:5173/bookHotelRooms',
                                'http://localhost:5173/bookMetroTickets',
                                'http://localhost:5173/bookBusTickets',
                                'http://localhost:5173/bookMovieTickets',
                                'http://localhost:5173/about',
                                'http://localhost:5173/checkTrainLiveStatus',
                                'http://localhost:5173/checkPnrStatus',
                              ], onRedirectCallback: () => { } })} content="Log in" style={{ width: '110px', height: '45px' }}> Log in</Button></li>
