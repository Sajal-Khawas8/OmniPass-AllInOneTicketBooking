        ...
        <header>
            ...
            <nav className={navOpened ? "nav_text active" : "nav_text"}>
                <ul>
                    ...
                    {
                        isAuthenticated ?
                            <li><Button onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })} content="Log out" style={{ width: '110px', height: '37px', marginBottom: '52px' }}>
                                Log Out
                            </Button></li>
                            :
                            <li> <Button className='active' onClick={() => loginWithRedirect({ redirectUri: window.location.href, onRedirectCallback: () => {} })} content="Log in" style={{ width: '110px', height: '45px', marginBottom: '52px' }}> Log in</Button></li>
